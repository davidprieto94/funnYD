...
var template2 = _.template('<article relacion-data="" class="dropzone col-3" dropzone-data="true"> <img src="https://s3.amazonaws.com/funnyd/images/casillas/CasRutDia<%- index %>.png" width="210" height="130"> </article>')
board = "#register"
game = "#game"
wellcome = "#wellcome"
notes_reristered = [];
