$(document).ready(function(){
    ...
    function createMessage(msg) {
        ...
        if (msg.tipo == 0){
            ...
            seccion.classList.add("alert-danger")
            // icono.innerHTML = "X"
        }else if(msg.tipo == 1){
            /*Mensaje de correcto*/
            seccion.classList.add("alert")
            seccion.classList.add("alert-success")
            // icono.innerHTML = "V"
        }
    ...
    function dragStartFunction(evento) {
        ...
        evento.dataTransfer.setData("text/plain",this.getAttribute("relacion-data"),1)
    ...
    function radomnise() {
        for (i=0; i<=4; i++){
            var d1 = random($("#draggablesContenedor_js").find("section").length,0);
            var d2 = random($("#draggablesContenedor_js").find("section").length,0);
            $($("#draggablesContenedor_js").find("section")[d1]).insertAfter($("#draggablesContenedor_js").find("section")[d2]);
        }
